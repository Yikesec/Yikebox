...
class english:
    ...
    Yikebox_description = "For use by Yikesec and verified users ONLY, unverfied access will result in termination using Project Gemini"
    ...
    choose_category = Color.purple+"[?] "+Color.green+"(Request)"+Color.white+" What kind of tools do you want to install? [1-10] > "+Color.no_colored
    which_tools = Color.purple+"[?] "+Color.green+"(Request)"+Color.white+" Which tools do you want to install? [1-{}] > "+Color.no_colored
    choose_language = Color.purple+"[?] "+Color.green+"(Request)"+Color.white+" Choose your language > "+Color.no_colored
...
# ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
# I`m pretty sure that this is redundant as i removed he language switcher becausde im a lazy fuck and cba coding it, i cant remember (he forgor💀)
